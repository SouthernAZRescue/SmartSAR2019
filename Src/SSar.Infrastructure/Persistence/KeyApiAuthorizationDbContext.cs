...
namespace SSar.Infrastructure.Persistence
{
    ...
    ///
    /// This is included because the existing ApiAuthorizationDbContext, which extends the IdentityDbContext for
    /// use with Identity server, does not provide for the role customization (abstraction) we're using
    /// in this app.
    ///
